...
static function X2AbilityTemplate RapidStun()
{
	...
	Effect.TriggeredEvent = 'LW_RapidStun';
	Effect.bShowFlyOver = true;
	Effect.CountValueName = 'LW_RapidStun_Uses';
	...
	Template = SelfTargetActivated('LW_RapidStun', "img:///BstarsPerkPack_Icons.UIPerk_RapidStun", true, Effect,, eCost_Free);
...
static function X2AbilityTemplate SawedOffOverwatch()
{
	...
	Template = Attack('LW_SawedOffOverwatch', "img:///'BstarsPerkPack_Icons.UIPerk_SawedOffOverwatch'", false, none, class'UIUtilities_Tactical'.const.CLASS_SERGEANT_PRIORITY, eCost_None);
...
static function X2AbilityTemplate LW_LeadTheTarget()
{
	...
	Template.IconImage = "img:///UILibrary_LW_Class_Pack.perk_LeadTheTarget";
...
static function X2AbilityTemplate LW_BlindingProtocol()
{
	...
	Template.IconImage = "img:///UILibrary_LW_Class_Pack.perk_BlindingProtocol"; 
	Template.AbilitySourceName = 'eAbilitySource_Perk';
...
static function X2AbilityTemplate LW_ZoneOfControl()
{
	...
	Template.IconImage = "img:///UILibrary_LW_Class_Pack.perk_ZoneOfControl";
	Template.AbilitySourceName = 'eAbilitySource_Perk';
	Template.eAbilityIconBehaviorHUD = EAbilityIconBehavior_NeverShow;
	Template.Hostility = eHostility_Neutral;
	Template.AbilityToHitCalc = default.DeadEye;
...
static function X2AbilityTemplate Impulse()
{
	...
	// Create the template using a helper function
	Template = Passive('LW_Impulse', "img:///UILibrary_FavidsPerkPack.UIPerk_Momentum", false, OffenseEffect);
...
static function X2AbilityTemplate Disassembly()
{
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'Disassembly');
...
//END AUTOGENERATED CODE: Template Overrides 'FullThrottle'
	...
	Template.BuildNewGameStateFn = TypicalAbility_BuildGameState;
	Template.BuildVisualizationFn = TypicalAbility_BuildVisualization;
	Template.AdditionalAbilities.AddItem('DisassemblyPassive');
