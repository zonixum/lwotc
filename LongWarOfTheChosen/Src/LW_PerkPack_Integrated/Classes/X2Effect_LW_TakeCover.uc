...
class X2Effect_LW_TakeCover extends X2Effect_Persistent implements(XMBEffectInterface);
...
function RegisterForEvents(XComGameState_Effect EffectGameState)
{
	...
	if (TargetUnit.HasSoldierAbility('LW_TakeCover'))
		EventManager.RegisterForEvent(TargetObj, 'TakeCoverHunkerTriggered', TakeCoverHunkerTriggered, ELD_OnStateSubmitted,,TargetObj,, EffectObj);
	
	if (TargetUnit.HasSoldierAbility('EverVigilant'))
		EventManager.RegisterForEvent(TargetObj, 'EverVigilantOverwatchTriggered', EverVigilantOverwatchTriggered, ELD_OnStateSubmitted,,TargetObj,, EffectObj);
}
